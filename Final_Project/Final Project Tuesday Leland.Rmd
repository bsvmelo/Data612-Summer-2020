...
#ubcf_rtg <-normalize(ubcf_rtg)
ubcf_rtg<-ubcf_rtg[rowCounts(ubcf_rtg)>600,colCounts(ubcf_rtg)>1000]
#ubcf_rtg<-ubcf_rtg[,colCounts(ubcf_rtg)>1000]
...
recc_matrix<-sapply(ubcf_pred@items, function(x){colnames(ubcf_rtg)[x]})
dim(recc_matrix)
recc_matrix[,1:10]
