...
Using Cosine similarity measure, k-fold splitting method yields lower errors.     
Using Pearson similarity measure, split method yields lower errors.

- In general,the split-pearson combination is the recommender with lowest prediction error.
...
- Train/Test split method:
Using Cosine similarity measure, bootstrapping method yields lower errors.     
Using Pearson similarity measure, split method yields lower errors.

- In general,the split-pearson combination is the recommender with lowest prediction error.

Comparing the results of UBCF with IBCF, UBCF accuracy is higher than IBCF. On both methods, the split-pearson combination is the most accurate amongst all combinations.
